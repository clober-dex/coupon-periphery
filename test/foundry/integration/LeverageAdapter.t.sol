...
contract LeverageAdapterIntegrationTest is Test, CloberMarketSwapCallbackReceiver, ERC1155Holder {
    ...
    function testLeverage() public {
        ...
        vm.prank(user);
        leverageAdapter.leverage{value: 0.16 ether}(
            waweth, wausdc, collateralAmount, borrowAmount, type(uint256).max, 2, data, permitParams
        );
    ...
    function testLeverageMore() public {
        ...
        vm.prank(user);
        leverageAdapter.leverageMore{value: 0.16 ether}(
